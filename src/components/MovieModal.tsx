    ...
    <div className="md:hidden flex flex-col h-[100dvh] w-full max-w-full overflow-hidden box-border relative dark">
      ...
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto overflow-x-hidden relative z-20">
        ...
        <motion.div
          ...
          className="relative bg-background rounded-t-3xl min-h-[70vh] shadow-[0_-10px_40px_rgba(0,0,0,0.3)]"
        >
          {/* Decorative handle */}
          ...
          {/* Tabs */}
          <motion.div variants={fadeInUp} className="px-4 border-b border-border/30">
          ...
          <div className="px-4 py-5 space-y-5 pb-28">
            ...
            {activeTab === "overview" && (
              <>
                {/* Rating visual bar */}
                <motion.div variants={fadeInUp} className="flex items-center gap-3 p-3 rounded-xl bg-card/60 border border-border/20">
                ...
                {/* Description */}
                {description && (
                  <motion.p variants={fadeInUp} className="text-sm text-muted-foreground leading-relaxed">
                    {displayDescription}
