        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="relative px-4 md:px-6 pb-4 md:pb-6 pt-12">
                ...
                >
                  ...
                  {/* Track */}
                  <div className="relative w-full h-[3px] group-hover/progress:h-[5px] transition-[height] duration-200 rounded-full">
                    {/* Background */}
                    ...
                    {/* Thumb */}
                    <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-0 h-0 group-hover/progress:w-[14px] group-hover/progress:h-[14px] rounded-full bg-[#c8f547] border-2 border-[#0d0d0d] shadow-[0_0_10px_rgba(200,245,71,0.6)] transition-all duration-200 z-10 [left:var(--progress-w)]" />
                  </div>
                </div>
          ...
          {/* ══════════════════════════════════════════════════════ */}
          {!isFullscreen && movie && (
            <div className="flex-shrink-0 bg-[#0a0a0a] border-t border-white/5 px-4 py-4 md:px-6 md:py-5">
